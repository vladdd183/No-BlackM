    ...
    try:
        if os.path.exists('.banner_840'):
            ...
            try:
                ...
                print(bannerTX[219:1541].replace('#','').replace('*','').replace('-','•'))
    ...
    try:
        ...
        if choice == '1':
            try:
                ...
                choice_ip = input(f'{CYAN}{BOLD}[~] {LI_G}Введите IP: {RESET}').strip()
                receiving_data_ip(choice_ip)
                exit()
            except KeyboardInterrupt:
                sys.exit(f'\n{CYAN}{BOLD}[!] {RED}Принудительная остановка кода{RESET}')
        elif choice == '2':
            try:
                ...
                choice_num=input(f'{PINK}{BOLD}[~] {LI_G}Введите номер телефона: {RESET}')
                ch_num=choice_num.replace('+', '').replace('-', '').replace('(', '').replace(')', '').replace(' ', '')
                if ch_num.isdigit():
                    if ch_num[0] == '8':
                        ch_num = ch_num[1:]
                        ch_num = '7'+ch_num
        ...
        if getNumber.isdigit():
            if getNumber[0] == '8':
                ...
                getNumber = '7'+getNumber
                return getNumber
            else:
                return getNumber
        else:
            exit(f'{YELLOW}{BOLD}[!] {RED}"{RESET}{getNumber}{RED}" - Не является номером\n{RESET}')
    except KeyboardInterrupt:
        sys.exit(f'\n{YELLOW}{BOLD}[!] {RED}Принудительная остановка кода..{RESET}')
def receiving_data_ip(ip):
    try:
        ...
        print(f'{CYAN}{BOLD}[+] {LI_G}IP: {RESET}{str(ip)}')
        ...
        try:
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Коде страны не найдены{RESET}')
                pass
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Код номеров:{F_CL} Неизвестно {RESET}')
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Коде номера не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Локации не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Языке не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Городе не найдены{RESET}')
                pass 
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Кодах машин не найдены{RESET}')
                pass  
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Широте не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{CYAN}{BOLD}[!] {RED}Данные о Долготе не найдены{RESET}')
                pass
            ...
            pass
        print(f'\n{CYAN}{BOLD}[!] {RED}Всего лимитов: {str(ip_data["limit"])}{RESET}')

    except KeyboardInterrupt:
        sys.exit(f'\n{CYAN}{BOLD}[!] {RED}Принудительная остановка кода{RESET}')
    except requests.exceptions.RequestException:
        sys.exit(f'{YELLOW}{BOLD}[!] {RED}Для проверки IP включите VPN и перезапустите. Ваш провайдер не поддерживает.{RESET}')                        
    except ValueError:
        sys.exit(f'{YELLOW}{BOLD}[!] {RED}Для проверки IP включите VPN и перезапустите. Ваш провайдер не поддерживает.{RESET}')
def num_mnp_request(number):
    try:
        ...
        try:
            ...
            try:
                ...
                # print(f'{PINK}{BOLD}[!] {RED}Данные о Операторе не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{PINK}{BOLD}[!] {RED}Данные о Городе не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{PINK}{BOLD}[!] {RED}Данные об URL Оператора не найдены{RESET}')
                pass
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Код страны:{F_CL} Неизвестно {RESET}')
                # print(f'{PINK}{BOLD}[!] {RED}Данные о Коде страны не найдены{RESET}')
                pass
            ...
            try:
                ...
                # print(f'{PINK}{BOLD}[!] {RED}Данные об Округе не найдены{RESET}')
                pass 
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Код машин:{F_CL} Неизвестно {RESET}')
                # print(f'{PINK}{BOLD}[!] {RED}Данные о Кодах машин не найдены{RESET}')
                pass   
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                if country["country_code3"] == 'UKR':
                    ...
                    # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Стране не найдены{RESET}')
                pass
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Код страны:{F_CL} Неизвестно {RESET}')
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Коде страны не найдены{RESET}') 
                pass
            ...
            try:
                ...
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Коде номера не найдены{RESET}') 
                pass
            ...
            try:
                ...
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Длине номера не найдены{RESET}') 
                pass
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Локация:{F_CL} Неизвестно {RESET}')
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Локации не найдены{RESET}')
                pass
        ...
        try:
            ...
            try:
                ...
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные об Номерах оператора не найдены{RESET}')  
                pass
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Широта:{F_CL} Неизвестно {RESET}')
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Широте не найдены{RESET}')
                pass
            ...
            try:
                ...
                print(f'{YELLOW}{BOLD}[!] {LI_G}Долгота:{F_CL} Неизвестно {RESET}')
                # print(f'{YELLOW}{BOLD}[!] {RED}Данные о Долготе не найдены{RESET}')
                pass
