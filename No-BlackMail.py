        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print(f'{CYAN}{BOLD}[!] {LI_G}Код страны:{F_CL} Неизвестно {RESET}')
                ...
                try:
                    ...
                    print(f'{CYAN}{BOLD}[!] {LI_G}Локация:{F_CL} Неизвестно {RESET}')
                ...
                try:
                    ...
                    print(f'{CYAN}{BOLD}[!] {LI_G}Код машин:{F_CL} Неизвестно {RESET}')
    ...
    while True:
        try:
            ...
            if number.isdigit():
                ...
                print(f'{PINK}{BOLD}[!] {RED}"{RESET}{number}{RED}" - Не является номером\n{RESET}')
                sleep(1)
                clear()
                continue
